...
class OauthApi
{
     ...
     */
    public function postOauth2Token($user_key, $authorization, $grant_type, $scope)
    {
        list($response) = $this->postOauth2TokenWithHttpInfo($user_key, $authorization, $grant_type, $scope);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function postOauth2TokenWithHttpInfo($user_key, $authorization, $grant_type, $scope)
    {
        // verify the required parameter 'user_key' is set
        if ($user_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_key when calling postOauth2Token');
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null) {
            throw new \InvalidArgumentException('Missing the required parameter $authorization when calling postOauth2Token');
        }
        // verify the required parameter 'grant_type' is set
        if ($grant_type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $grant_type when calling postOauth2Token');
        }
        // verify the required parameter 'scope' is set
        if ($scope === null) {
            throw new \InvalidArgumentException('Missing the required parameter $scope when calling postOauth2Token');
        }
        // parse inputs
