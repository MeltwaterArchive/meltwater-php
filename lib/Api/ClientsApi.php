...
class ClientsApi
{
    ...
    /**
     * Operation deleteV1ClientsClientId
     *
     * Delete client.
     *
     ...
     */
    public function deleteV1ClientsClientId($user_key, $authorization, $client_id)
    {
        list($response) = $this->deleteV1ClientsClientIdWithHttpInfo($user_key, $authorization, $client_id);
        return $response;
    }

    /**
     * Operation deleteV1ClientsClientIdWithHttpInfo
     *
     * Delete client.
     *
     * @param string $user_key The &#x60;user_key&#x60; from [developer.meltwater.io](https://developer.meltwater.io/admin/applications/). (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function deleteV1ClientsClientIdWithHttpInfo($user_key, $authorization, $client_id)
    {
        // verify the required parameter 'user_key' is set
        if ($user_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_key when calling deleteV1ClientsClientId');
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null) {
            throw new \InvalidArgumentException('Missing the required parameter $authorization when calling deleteV1ClientsClientId');
        }
        // verify the required parameter 'client_id' is set
        if ($client_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $client_id when calling deleteV1ClientsClientId');
        }
        // parse inputs
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function postV1Clients($user_key, $authorization)
    {
        list($response) = $this->postV1ClientsWithHttpInfo($user_key, $authorization);
        return $response;
    }

    /**
     * Operation postV1ClientsWithHttpInfo
     *
     * Register new client
     *
     * @param string $user_key The &#x60;user_key&#x60; from [developer.meltwater.io](https://developer.meltwater.io/admin/applications/). (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function postV1ClientsWithHttpInfo($user_key, $authorization)
    {
        // verify the required parameter 'user_key' is set
        if ($user_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_key when calling postV1Clients');
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null) {
            throw new \InvalidArgumentException('Missing the required parameter $authorization when calling postV1Clients');
        }
        // parse inputs
