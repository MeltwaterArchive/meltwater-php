...
/**
 * HooksCollection Class Doc Comment
 *
 * @category    Class */
 // @description List all hooks.     Delivers all previously generated hooks.    Requires an OAuth access token.
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class HooksCollection implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'HooksCollection';
    ...
    protected static $swaggerTypes = array(
        'hooks' => '\Swagger\Client\Model\Hook[]'
    );
    ...
    /**
     * Sets hooks
     * @param \Swagger\Client\Model\Hook[] $hooks
     * @return $this
     */
